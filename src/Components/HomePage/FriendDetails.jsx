    ...
    <div>{
        ...
        <p className='text-[#64748B] text-[14px]'>Preferred: {friend.email}</p>
           ...
           <div className='col-span-2'>
            ...
            <div className='flex justify-between p-6 shadow-sm mt-6'>
            ...
            <div className='shadow-sm mt-6 p-6'>
                ...
                <div className='flex gap-4 mt-4'>
                    <button className='btn flex flex-col items-center justify-center gap-2 w-60 h-25'><FiPhoneCall className='text-2xl' />Call</button>
                    <button className='btn flex flex-col items-center justify-center gap-2 w-60 h-25'><MdOutlineTextsms className='text-2xl' />Text</button>
                    <button className='btn flex flex-col items-center justify-center gap-2 w-60 h-25'><GoDeviceCameraVideo className='text-2xl' />Video</button>
                </div>
            </div>
           </div>
            </div>
